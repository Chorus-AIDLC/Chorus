...
> Easier path: install the Chorus CLI globally with `npm install -g @chorus-aidlc/chorus@0.17.3`, then run `chorus agents add --agents codex` and it will write this block (and `~/.codex/.env`) for you, plus enable the lifecycle hooks.
