# reviewer-finding-identity Specification

## Purpose
TBD - created by archiving change trackable-reviewer-findings. Update Purpose after archive.
## Requirements
...
- **WHEN** a round-3 review must acknowledge seven findings carried over from earlier rounds
- **THEN** all seven acknowledgement lines are written even though seven exceeds five, because the
  limit of five governs newly-raised NOTEs only — and in round 2 and later there are no
  newly-raised NOTEs at all
