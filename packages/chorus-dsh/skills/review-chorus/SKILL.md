...
> **Note:** Creating ideas is a PM tool (`chorus_pm_create_idea`). See `idea-chorus`.
...
- For Idea elaboration (before proposals), see `idea-chorus`
- For Proposal creation (what you're reviewing), see `proposal-chorus`
- For Developer workflow (what you're verifying), see `develop-chorus`
