...
describe("claimIdea", () => {
  ...
  it("should throw if idea is elaborated", async () => {
    ...
    ).rejects.toThrow("Cannot claim an already elaborated Idea");
  });
...
describe("assignIdea", () => {
  ...
  it("should keep current status when reassigning non-open idea (elaborating)", async () => {
    const existing = makeIdeaRecord({
      status: "elaborating",
      assigneeType: "agent",
  ...
  it("should throw if idea is elaborated", async () => {
    ...
    ).rejects.toThrow("Cannot assign an already elaborated Idea");
  });
...
describe("releaseIdea", () => {
  ...
  it("should throw if idea is elaborated", async () => {
    ...
    await expect(releaseIdea(IDEA_UUID)).rejects.toThrow(
      "Cannot release an already elaborated Idea"
    );
  });
